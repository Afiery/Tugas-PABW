...
<?php
    ...
    if(isset($_GET['kode_mk'])){
        ...
        $matkul = new Lib();
        $matkull = $matkul->editDataMK($_GET['kode_mk']);
        $edit = $matkull->fetch(PDO::FETCH_OBJ);
    }
?>
<div class="container">
<h2>Tambah Mata Kuliah</h2><br>
    <div class="row">
        <div class="col-sm-6">
            <form action="" method="post">
                ...
                <a href="MataKuliah.php"><input type="button" class="btn btn-danger btn-sm" value="Back"></a>
            </form>
        </div>
    </div>
</div>
...
<?php
    if(isset($_POST['submit'])){
        ...
        $edit = $matkul->updateDataMK($kode_mk, $nama_mk);
        if($edit == 'Berhasil'){
